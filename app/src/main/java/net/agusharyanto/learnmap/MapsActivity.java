package net.agusharyanto.learnmap;
...
public class MapsActivity extends FragmentActivity {
    ...
    private String[] places = {"ATM", "Bank", "Cafe", "Fire-Station", "Hospital", "Pharmacy", "Police", "Restaurant", "Shopping Mall"};
    private String[] placesname = {"ATM", "Bank", "Cafe", "Pos Pemadam Kebakaran", "Rumah Sakit", "Apotik", "Kantor Polisi", "Rumah Makan", "Tempat Belanja"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> placeAdapter = new ArrayAdapter<String>(MapsActivity.this, android.R.layout.simple_spinner_item, placesname);
    ...
    private class GetPlaces extends AsyncTask<Void, Void, ArrayList<Place>> {
                ...
                mMap.addMarker(new MarkerOptions()
                        ...
                        .position(
                                new LatLng(result.get(i).getLatitude(), result
                                        .get(i).getLongitude()))
                        .icon(BitmapDescriptorFactory
                                .fromResource(R.drawable.marker_pink))
        ...
        protected ArrayList<Place> doInBackground(Void... arg0) {
            ...
            //PlacesService service = new PlacesService("AIzaSyC49cKzFqAlVqH6TN1rQa_3i2qmYOk6gUg");
            PlacesService service = new PlacesService("AIzaSyDDfPTAeQB2gDcwU6nIUkjIaKrbBkHR4ug");
